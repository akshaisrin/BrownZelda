...
class MiniBoss(Monster):
    ...
    def __init__(self, attack_power:float, health:float, img:pygame.image, mini_boss_name:str, start_pos_x:int, start_pos_y:int, height:int, width:int, proj_img:str, proj_height, proj_width):
